...
public class Radio extends ElectronicDevice {
  ...
  public String toString() {
    ...
    return super.toString() + " | " + String.format("Radio[volume=%d, frequency=%f, modulation=%s, minFrequency=%f, maxFrequency=%f, isOn: %b]", getVolume(), getFrequency(), getModulation(), getMinFrequency(), getMaxFrequency(), isOn());
  }
